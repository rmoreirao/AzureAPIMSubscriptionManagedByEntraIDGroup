...
public sealed class ManageGroupSubscription
{
    ...
    private readonly ILogger<ManageGroupSubscription> _logger;

    public ManageGroupSubscription(ApimManagementService apim, CosmosRepository repository, GraphService graph, RequestAuthService auth, ILogger<ManageGroupSubscription> logger)
    {
        _apim = apim;
    ...
    [Function("ManageGroupSubscription")]
    public async Task<HttpResponseData> Run(
        [HttpTrigger(AuthorizationLevel.Anonymous, "post", Route = "group-subscriptions/{entraIdGroup}/{subscriptionId}/{action}")] HttpRequestData req,
        string entraIdGroup,
