...
public sealed class SaveGroupSubscriptionApim
{
    ...
    public SaveGroupSubscriptionApim(ApimManagementService apim, CosmosRepository repository, ApimGroupService groups, RequestAuthService auth, ILogger<SaveGroupSubscriptionApim> logger)
    {
        _apim = apim;
