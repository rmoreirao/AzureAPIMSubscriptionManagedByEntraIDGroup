...
public sealed class GetGroupSubscriptionsApim
{
    ...
    private readonly ILogger<GetGroupSubscriptionsApim> _logger;

    public GetGroupSubscriptionsApim(CosmosRepository repository, ApimGroupService groups, ApimManagementService apim, RequestAuthService auth, ILogger<GetGroupSubscriptionsApim> logger)
    {
    ...
    [Function("GetGroupSubscriptionsApim")]
    public async Task<HttpResponseData> Run(
        [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "apim/group-subscriptions")] HttpRequestData req,
